    ...
    <section className="relative z-30 bg-[#21180f] px-4 py-4 text-white">
      <div className="mx-auto grid max-w-6xl gap-3 rounded-[28px] border border-white/10 bg-white/8 p-4 backdrop-blur-xl sm:grid-cols-[1fr_auto] sm:items-center">
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex">
          <a href={first.landingUrl} target="_blank" rel="noreferrer" className="grid min-h-11 place-items-center rounded-full bg-[#2f8f55] px-5 text-sm font-black text-white">عرض اللقطة</a>
          <a href="/create" className="grid min-h-11 place-items-center rounded-full bg-white px-5 text-sm font-black text-[#21180f]">اصنع لقطة جديدة</a>
        </div>
      </div>
    </section>
  );
